...
class Equation:
    ...
    def evaluate_equation(self, remove_equation_fields= False, verbose=True):
        evaluated_dict = evaluate_equation_dict(self.equation_dict, verbose=True) #this function is from the evaluator module
